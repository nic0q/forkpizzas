...
export default function FoodCard({name, ingredients = [], add, img, size, price}) {
  return (
    <div className={"flex-row rounded-lg border-2 text-center m-1 pb-2 bg-gray-200 w-48"}>
      ...
      <div className='h-[10%] mt-2'>
        <h5>{to_clp(price)}</h5>
        <div className='flex bg-green-500 font-sans align-center justify-center items-center text-center cursor-pointer my-3 mx-2 py-2 rounded-xl text-xs text-white' onClick={add}>
          <BsFillCartPlusFill/>
